...
src/%.o: ../src/%.c
	...
	arm-xilinx-eabi-gcc -Wall -O0 -g3 -I"/home/jared/Research/workspace/ZC702_hw_platform" -c -fmessage-length=0 -I../../zynq_bare_bsp/ps7_cortexa9_0/include -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
